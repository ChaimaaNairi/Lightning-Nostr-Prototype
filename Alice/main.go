...
func main() {
	...
	fmt.Println("Alice's private key (sk):", privateKey)
	fmt.Println("Alice's public key (pk):", publicKey)

	nameMap := map[string]string{
		publicKey: "Alice",
		"fab28a32bc209bfee51d13ab724d9e18edf40216147df79d50129886fef73759": "Bob",
		"b4be216068a9df082bd9b2729043a4e3c7d0357f12b862a04c61504bf45f25dc": "Charlie",
	}
